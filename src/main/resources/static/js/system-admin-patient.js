window.addEventListener("load", function () {
    ...
    formActualizar.addEventListener("submit", function (event) {
      ...
      const inputActualizarCalle =  document.getElementById("actualizar-calle").value;
      const inputActualizarNumero =  document.getElementById("actualizar-numero").value;
      const inputActualizarLocalidad =  document.getElementById("actualizar-localidad").value;
      const inputActualizarProvincia =  document.getElementById("actualizar-provincia").value;
      const inputActualizarCodigoPostal =  document.getElementById("actualizar-cp").value;
      const inputActualizarPais =  document.getElementById("actualizar-pais").value;
    ...
    let textoBuscarError = document.querySelector(".buscar-paciente .texto-error");
    ...
    let textoEliminarError = document.querySelector(".eliminar-paciente .texto-error");
